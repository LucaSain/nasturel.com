...
export default function Background() {
  return (
    <div className="w-screen  h-screen absolute left-0 right-0 z-0">
      ...
      <div className="absolute hover:translate-y-[-10px] transition-all duration-700 z-10 w-72 sm:w-70 xl:w-96 left-20 sm:left-5 xl:left-20 bottom-10 sm:bottom-5 md:top-40 rotate-12">
        <Clouds.Cloud4 />
      </div>
      <div className="absolute hover:translate-y-[-10px] transition-all duration-700 z-10 w-56 sm:w-56 left-5 top-20 sm:left-10 sm:bottom-5 lg:top-64 ">
        <Clouds.Cloud5 />
      </div>
      ...
      <div className="absolute hidden sm:block hover:translate-y-[-10px] transition-all duration-700 z-10 w-96 bottom-10 right-40 rotate-12">
        <Clouds.Cloud7 />
      </div>
